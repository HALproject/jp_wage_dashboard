...
import pydeck as pdk # 3dMap
import plotly.express as px #chart

st.title('日本の賃金データダッシュボード')

input_path = './csv_data/'
encode = 'shift_jis'
df_jp_ind = pd.read_csv(input_path + '雇用_医療福祉_一人当たり賃金_全国_全産業.csv', encoding=encode)
df_jp_category = pd.read_csv(input_path + '雇用_医療福祉_一人当たり賃金_全国_大分類.csv', encoding=encode)
df_pref_ind = pd.read_csv(input_path + '雇用_医療福祉_一人当たり賃金_都道府県_全産業.csv', encoding=encode)
